...
import 'package:my_place/responsive_widget.dart';
...
class ProfilePage extends StatelessWidget {
  ...
  List<Widget> navButtons() => [
        ...
        NavButton(
          text: "contact",
          onPressed: () {
            html.window.open("https://www.linkedin.com/in/ipshitaghosh13/detail/contact-info/", "Contact");
          },
        ),
      ];
...
//            borderRadius: BorderRadius.circular(40),
  ...
  final profileData = Column(
    ...
    children: <Widget>[
      ...
      Text(
        "A Developer by heart, and a student,\n"
        "I love to see my github graph green,\n"
        "just like the way I want to see our planet.",
        softWrap: true,
        textScaleFactor: 1.5,
      ...
      Row(
        ...
        children: <Widget>[
          RaisedButton(
            ...
            onPressed: () {
              html.window.open(
                  "https://www.slideshare.net/slideshow/embed_code/key/9OG8KFeMzR2Idm",
                  "Resume");
            },
